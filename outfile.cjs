...
var require_tinycolor = __commonJS({
  "node_modules/.pnpm/tinycolor2@1.4.2/node_modules/tinycolor2/tinycolor.js"(exports, module2) {
    (function(Math2) {
...
var require_gradient_string = __commonJS({
  "node_modules/.pnpm/gradient-string@2.0.1/node_modules/gradient-string/index.js"(exports, module2) {
    ...
    module2.exports = InitGradient2;
    for (const a in aliases) {
      module2.exports[a] = (str) => new InitGradient2(aliases[a].colors)(str, aliases[a].options);
      module2.exports[a].multiline = (str) => new InitGradient2(aliases[a].colors).multiline(str, aliases[a].options);
    }
  }
});
...
var banner = (0, import_gradient_string.default)([
  { color: "#42d392", pos: 0 },
  { color: "#42d392", pos: 0.1 },
  { color: "#647eff", pos: 1 }
])("dc tool - tiny cli for medical FE group");
...
function canSafelyOverwrite(dir) {
  return !fs3.existsSync(dir) || fs3.readdirSync(dir).length === 0;
}
function emptyDir(dir) {
  if (!fs3.existsSync(dir)) {
    return;
  }
  postOrderDirectoryTraverse(dir, (dir2) => fs3.rmdirSync(dir2), (file) => fs3.unlinkSync(file));
}
async function init() {
  console.log(`
${banner_default}
`);
  ...
  const root = path3.join(cwd, targetDir);
...
\u9879\u76EE\u521D\u59CB\u5316\u5728 ${root}...`);
  ...
  fs3.writeFileSync(path3.resolve(root, "package.json"), JSON.stringify(pkg, null, 2));
  const templateRoot = path3.resolve(__dirname, "template");
  const render = function render2(templateName) {
    const templateDir = path3.resolve(templateRoot, templateName);
...
`);
  if (root !== cwd) {
    console.log(`  ${bold(green(`cd ${path3.relative(cwd, root)}`))}`);
  }
